...
admin.site.register(models.Stock6Sign202407)
admin.site.register(models.Stock6Sign202408)
admin.site.register(models.Stock6Sign202409)
admin.site.register(models.Stock6Sign202410)
admin.site.register(models.Stock6Sign202411)
admin.site.register(models.Stock6Sign202412)